...
## Getting Started 
 Due to .NET Framework deployment issues. The application has been broken out into a different git projects one for hosting and the other is the full project.
